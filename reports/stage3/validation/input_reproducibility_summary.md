...
* extraction: `/tmp/stage3-method-body-run2.zHl9f6`
* semantic input destination: `/tmp/stage3-semantic-final3-run2.u3sWj7`
* report destination: `/tmp/stage3-reports-final3-run2.xNR1LD`
