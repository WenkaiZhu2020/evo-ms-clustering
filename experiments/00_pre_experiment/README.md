...
- run DayTrader constrained internal-primary calibration with reference-based sanity checks
...
- `calibration/`: DayTrader constrained internal-primary calibration outputs from `run_daytrader_calibration.py`.
...
- `run_daytrader_calibration.py`: DayTrader resolution and SSA-weight calibration with internal structural metrics as primary selection signals.
