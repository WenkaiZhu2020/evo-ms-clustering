#!/usr/bin/env python3
"""Run the frozen four-objective Stage 3 NSGA-II pipeline.
...
def subject_paths(subject: str) -> dict[str, Path]:
    ...
    graph = ROOT / "results" / subject / "04_stage3_semantic" / "graph"
    return {
...
def load_context(subject: str) -> dict[str, Any]:
    ...
    graph_manifest = manifest["semantic_graph_hashes"][subject]
